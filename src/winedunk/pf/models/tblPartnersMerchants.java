...
@NamedQueries({
	...
	@NamedQuery(name="tblPartnersMerchants.findOneByShopIdAndPartnerId", query="SELECT x FROM tblPartnersMerchants x WHERE x.shopId = :shopId AND x.partnerId = :partnerId"),
